...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/auth/forget-password'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/auth/reset-password'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
