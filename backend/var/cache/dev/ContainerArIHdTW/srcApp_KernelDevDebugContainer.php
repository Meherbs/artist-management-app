...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\Api\\CreateRepresentative' => 'getCreateRepresentativeService',
    ...
    /**
     * Gets the public 'App\Controller\Api\CreateRepresentative' shared autowired service.
     *
     * @return \App\Controller\Api\CreateRepresentative
     */
    protected function getCreateRepresentativeService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Api'.\DIRECTORY_SEPARATOR.'CreateRepresentative.php';

        return $this->services['App\\Controller\\Api\\CreateRepresentative'] = new \App\Controller\Api\CreateRepresentative(($this->privates['App\\Repository\\EmailAdressRepository'] ?? $this->getEmailAdressRepositoryService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Api'.\DIRECTORY_SEPARATOR.'CreateUser.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Manager'.\DIRECTORY_SEPARATOR.'UserManager.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Services'.\DIRECTORY_SEPARATOR.'PasswordService.php';

        return $this->services['App\\Controller\\Api\\CreateUser'] = new \App\Controller\Api\CreateUser(new \App\Manager\UserManager(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), new \App\Services\PasswordService(($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService())), ($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService())));
    }
    ...
    protected function getApiPlatform_SwaggerUi_ActionService()
    {
        ...
        return $this->services['api_platform.swagger_ui.action'] = new \ApiPlatform\Core\Bridge\Symfony\Bundle\SwaggerUi\SwaggerUiAction(($this->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService()), NULL, ($this->services['router'] ?? $this->getRouterService()), ($this->services['serializer'] ?? $this->getSerializerService()), ($this->privates['api_platform.openapi.factory'] ?? $this->getApiPlatform_Openapi_FactoryService()), ($this->privates['api_platform.openapi.options'] ?? $this->getApiPlatform_Openapi_OptionsService()), new \ApiPlatform\Core\Bridge\Symfony\Bundle\SwaggerUi\SwaggerUiContext(false, true, false, false, false, false, NULL), $this->parameters['api_platform.formats'], '', '');
    }
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('IygzBupASM', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0oTnvKXuWr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'doctrine.doctrineSuscriber' => ['privates', 'doctrine.doctrineSuscriber', 'getDoctrine_DoctrineSuscriberService', false],
            'doctrine.orm.default_listeners.attach_entity_listeners' => ['privates', 'doctrine.orm.default_listeners.attach_entity_listeners', 'getDoctrine_Orm_DefaultListeners_AttachEntityListenersService', false],
        ], [
            'doctrine.doctrineSuscriber' => '?',
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
        ]), [0 => 'doctrine.doctrineSuscriber']);
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\CelebrityRepository' => ['privates', 'App\\Repository\\CelebrityRepository', 'getCelebrityRepositoryService', false],
            'App\\Repository\\ConnectionsRepository' => ['privates', 'App\\Repository\\ConnectionsRepository', 'getConnectionsRepositoryService', false],
            'App\\Repository\\EmailAdressRepository' => ['privates', 'App\\Repository\\EmailAdressRepository', 'getEmailAdressRepositoryService', false],
            'App\\Repository\\LogRepository' => ['privates', 'App\\Repository\\LogRepository', 'getLogRepositoryService', false],
            'App\\Repository\\RepresentativeRepository' => ['privates', 'App\\Repository\\RepresentativeRepository', 'getRepresentativeRepositoryService', false],
            ...
            'App\\Repository\\CelebrityRepository' => '?',
            'App\\Repository\\ConnectionsRepository' => '?',
            'App\\Repository\\EmailAdressRepository' => '?',
            'App\\Repository\\LogRepository' => '?',
            'App\\Repository\\RepresentativeRepository' => '?',
    ...
    protected function getServicesResetterService()
    {
        ...
        return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
            ...
            if (isset($this->privates['monolog.dbHandler'])) {
                yield 'monolog.dbHandler' => ($this->privates['monolog.dbHandler'] ?? null);
            }
    ...
    /**
     * Gets the private '.errored..service_locator.wd8jhBu.App\Entity\Representative' shared service.
     *
     * @return \App\Entity\Representative
     */
    protected function getRepresentativeService()
    {
        $this->throw('Cannot autowire service ".service_locator.wd8jhBu": it references class "App\\Entity\\Representative" but no such service exists.');
    }
    ...
    /**
     * Gets the private '.service_locator.c.BgjzC' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_C_BgjzCService()
    {
        return $this->privates['.service_locator.c.BgjzC'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\ApiController::forgetPassword' => ['privates', '.service_locator.8ZuNAXa', 'get_ServiceLocator_8ZuNAXaService', false],
            'App\\Controller\\ApiController::resetPassword' => ['privates', '.service_locator.qZ_VNPK', 'get_ServiceLocator_QZVNPKService', false],
            'App\\Controller\\Api\\CreateRepresentative::__invoke' => ['privates', '.service_locator.wd8jhBu', 'get_ServiceLocator_Wd8jhBuService', false],
            'App\\Controller\\ApiController:forgetPassword' => ['privates', '.service_locator.8ZuNAXa', 'get_ServiceLocator_8ZuNAXaService', false],
            'App\\Controller\\ApiController:resetPassword' => ['privates', '.service_locator.qZ_VNPK', 'get_ServiceLocator_QZVNPKService', false],
            'App\\Controller\\Api\\CreateRepresentative:__invoke' => ['privates', '.service_locator.wd8jhBu', 'get_ServiceLocator_Wd8jhBuService', false],
            'App\\Controller\\Api\\CreateRepresentative' => ['privates', '.service_locator.wd8jhBu', 'get_ServiceLocator_Wd8jhBuService', false],
        ], [
            'App\\Controller\\ApiController::forgetPassword' => '?',
            'App\\Controller\\ApiController::resetPassword' => '?',
            'App\\Controller\\Api\\CreateRepresentative::__invoke' => '?',
            'App\\Controller\\ApiController:forgetPassword' => '?',
            'App\\Controller\\ApiController:resetPassword' => '?',
            'App\\Controller\\Api\\CreateRepresentative:__invoke' => '?',
            'App\\Controller\\Api\\CreateRepresentative' => '?',
        ]);
    }
    ...
    /**
     * Gets the private '.service_locator.wd8jhBu' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Wd8jhBuService()
    {
        return $this->privates['.service_locator.wd8jhBu'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'data' => ['privates', '.errored..service_locator.wd8jhBu.App\\Entity\\Representative', NULL, 'Cannot autowire service ".service_locator.wd8jhBu": it references class "App\\Entity\\Representative" but no such service exists.'],
        ], [
            'data' => 'App\\Entity\\Representative',
        ]);
    }
    ...
    /**
     * Gets the private 'App\Repository\CelebrityRepository' shared autowired service.
     *
     * @return \App\Repository\CelebrityRepository
     */
    protected function getCelebrityRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CelebrityRepository.php';

        return $this->privates['App\\Repository\\CelebrityRepository'] = new \App\Repository\CelebrityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\ConnectionsRepository' shared autowired service.
     *
     * @return \App\Repository\ConnectionsRepository
     */
    protected function getConnectionsRepositoryService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'persistence'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'Persistence'.\DIRECTORY_SEPARATOR.'ObjectRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'collections'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'Common'.\DIRECTORY_SEPARATOR.'Collections'.\DIRECTORY_SEPARATOR.'Selectable.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'ORM'.\DIRECTORY_SEPARATOR.'EntityRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'doctrine-bundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'doctrine-bundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConnectionsRepository.php';

        return $this->privates['App\\Repository\\ConnectionsRepository'] = new \App\Repository\ConnectionsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\EmailAdressRepository' shared autowired service.
     *
     * @return \App\Repository\EmailAdressRepository
     */
    protected function getEmailAdressRepositoryService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'persistence'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'Persistence'.\DIRECTORY_SEPARATOR.'ObjectRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'collections'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'Common'.\DIRECTORY_SEPARATOR.'Collections'.\DIRECTORY_SEPARATOR.'Selectable.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'ORM'.\DIRECTORY_SEPARATOR.'EntityRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'doctrine-bundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'doctrine-bundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmailAdressRepository.php';

        return $this->privates['App\\Repository\\EmailAdressRepository'] = new \App\Repository\EmailAdressRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\RepresentativeRepository' shared autowired service.
     *
     * @return \App\Repository\RepresentativeRepository
     */
    protected function getRepresentativeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'persistence'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'Persistence'.\DIRECTORY_SEPARATOR.'ObjectRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'collections'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'Common'.\DIRECTORY_SEPARATOR.'Collections'.\DIRECTORY_SEPARATOR.'Selectable.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'ORM'.\DIRECTORY_SEPARATOR.'EntityRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'doctrine-bundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'doctrine-bundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RepresentativeRepository.php';

        return $this->privates['App\\Repository\\RepresentativeRepository'] = new \App\Repository\RepresentativeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nCMmQgYasn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y3wUt4AzkA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ksB3ZzEj7j', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2UFLw+0ON6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j1oa3OKR3W', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SuMACWNXq8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Vtb1EMRQkE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getConsole_Command_CachePoolListService()
    {
        ...
        $this->privates['console.command.cache_pool_list'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolListCommand([0 => 'cache.app', 1 => 'cache.system', 2 => 'cache.validator', 3 => 'cache.serializer', 4 => 'cache.annotations', 5 => 'cache.property_info', 6 => 'api_platform.cache.route_name_resolver', 7 => 'api_platform.cache.identifiers_extractor', 8 => 'api_platform.cache.subresource_operation_factory', 9 => 'api_platform.cache.metadata.resource', 10 => 'api_platform.cache.metadata.property', 11 => 'cache.doctrine.orm.default.result', 12 => 'cache.doctrine.orm.default.query', 13 => 'cache.security_expression_language']);
    ...
    /**
     * Gets the private 'doctrine.doctrineSuscriber' shared autowired service.
     *
     * @return \App\EventListener\DoctrineSuscriber
     */
    protected function getDoctrine_DoctrineSuscriberService()
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'DoctrineSuscriber.php';

        return $this->privates['doctrine.doctrineSuscriber'] = new \App\EventListener\DoctrineSuscriber(($this->services['monolog.logger.db'] ?? $this->getMonolog_Logger_DbService()));
    }
    ...
    protected function getMonolog_DbHandlerService()
    {
        ...
        $this->privates['monolog.dbHandler'] = $instance = new \App\Utility\DbHandler(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

        $instance->pushProcessor(new \App\Utility\DbProcessor(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), new \Symfony\Component\Security\Core\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'security.authorization_checker' => ['services', 'security.authorization_checker', 'getSecurity_AuthorizationCheckerService', false],
            'security.token_storage' => ['services', 'security.token_storage', 'getSecurity_TokenStorageService', false],
        ], [
            'security.authorization_checker' => '?',
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/forget-password'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/uploadedFiles'), [0 => 'IS_AUTHENTICATED_FULLY'], NULL);
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderaa0e3 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializere43eb = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties02272 = [
        
    ];

    public function getConnection()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getConnection', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getMetadataFactory', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getExpressionBuilder', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'beginTransaction', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->beginTransaction();
    }

    public function getCache()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getCache', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getCache();
    }

    public function transactional($func)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'transactional', array('func' => $func), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'wrapInTransaction', array('func' => $func), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'commit', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->commit();
    }

    public function rollback()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'rollback', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getClassMetadata', array('className' => $className), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'createQuery', array('dql' => $dql), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'createNamedQuery', array('name' => $name), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'createQueryBuilder', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'flush', array('entity' => $entity), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'clear', array('entityName' => $entityName), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->clear($entityName);
    }

    public function close()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'close', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->close();
    }

    public function persist($entity)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'persist', array('entity' => $entity), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'remove', array('entity' => $entity), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'refresh', array('entity' => $entity), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'detach', array('entity' => $entity), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'merge', array('entity' => $entity), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getRepository', array('entityName' => $entityName), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'contains', array('entity' => $entity), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getEventManager', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getConfiguration', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'isOpen', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getUnitOfWork', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getProxyFactory', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'initializeObject', array('obj' => $obj), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'getFilters', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'isFiltersStateClean', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'hasFilters', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return $this->valueHolderaa0e3->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializere43eb = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderaa0e3) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderaa0e3 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderaa0e3->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, '__get', ['name' => $name], $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        if (isset(self::$publicProperties02272[$name])) {
            return $this->valueHolderaa0e3->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderaa0e3;
    ...
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, '__set', array('name' => $name, 'value' => $value), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;
    ...
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, '__isset', array('name' => $name), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;
    ...
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, '__unset', array('name' => $name), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;
    ...
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, '__clone', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        $this->valueHolderaa0e3 = clone $this->valueHolderaa0e3;
    }

    public function __sleep()
    {
        $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, '__sleep', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;

        return array('valueHolderaa0e3');
    }
    ...
    {
        $this->initializere43eb = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializere43eb;
    }

    public function initializeProxy() : bool
    {
        return $this->initializere43eb && ($this->initializere43eb->__invoke($valueHolderaa0e3, $this, 'initializeProxy', array(), $this->initializere43eb) || 1) && $this->valueHolderaa0e3 = $valueHolderaa0e3;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderaa0e3;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderaa0e3;
    }
